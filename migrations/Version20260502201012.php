    ...
    public function up(Schema $schema): void
    {
        $this->addSql('
            CREATE TABLE tournament_session_team (
                ...
                PRIMARY KEY (id),
                CONSTRAINT FK_tst_session FOREIGN KEY (tournament_session_id) REFERENCES tournament_session (id),
                CONSTRAINT FK_tst_team FOREIGN KEY (team_id) REFERENCES team (id)
