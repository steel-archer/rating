...
final class Version20260503104937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $this->addSql('
            CREATE TABLE tournament_session_team_player (
                ...
                PRIMARY KEY (id),
                CONSTRAINT FK_tstp_session_team FOREIGN KEY (tournament_session_team_id) REFERENCES tournament_session_team (id),
                CONSTRAINT FK_tstp_player FOREIGN KEY (player_id) REFERENCES player (id)
